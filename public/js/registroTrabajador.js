...
document.addEventListener('DOMContentLoaded', () => {
    const form = document.getElementById('registroTrabajadorForm');
    ...
    form.addEventListener('submit', (e) => {
        ...
        } else if (!validarFechaContratacion(fechaContratacionInput.value)) {
            valid = false;
            mensaje = 'La fecha de contratacion no es valida.';
        } else if (!validarCURP(curpInput.value)) {
            valid = false;
            mensaje = 'CURP invalido.';
